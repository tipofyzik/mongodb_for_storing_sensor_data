...
3. Open CLI or IDE (integrated development environment) in the project directory. Then run "**_docker compose up --build_**" in the console to create docker images and run containers.
